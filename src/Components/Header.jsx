        ...
        <>
            <Popover className="relative bg-white">
                ...
                <div className="relative z-20">
                    <div className="flex max-w-7xl items-center justify-between py-6 px-5 md:justify-start md:space-x-10 ">
                        <div>
                        ...
                        <div className="hidden md:flex md:flex-1 md:items-center md:justify-between">
                            <Popover.Group as="nav" className="flex space-x-10">
                                <Popover>
                                    {({ open }) => (
                                        <>
                                            ...
                                            >
                                                <span className='text-[#10069F] hover:text-[#FC4191] font-semibold text-[18px]'>Innovation</span>
                                                <ChevronDownIcon
                                                    className={classNames(
                                ...
                                <a href="#" className="text-[#10069F] hover:text-[#FC4191] font-semibold text-[18px]">
                                    Products & Services
                                </a>
                                <a href="#" className="text-[#10069F] hover:text-[#FC4191] font-semibold text-[18px]">
                                    About
